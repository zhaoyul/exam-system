...
**YOU ARE IN: `exam/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/exam/` (rig root) or other directories
...
**Your mail address:** `exam/polecats/obsidian`
**Your rig:** exam
**Your Witness:** `exam/witness`
...
| Ask Witness for help | `gt mail send exam/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`exam/witness`) when:
...
```bash
gt mail send exam/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
