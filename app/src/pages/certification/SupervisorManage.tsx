...
import {
  UserCheck, Plus, Search, Shield, Trash2, Eye
} from 'lucide-react'
...
const mockSupervisors: Supervisor[] = [
  { id: 1, name: '张监考', gender: '男', phone: '13800138001', idCard: '440301198001011234', org: '大亚湾核电', site: '职业技能培训中心', role: '主监考', status: 'active', certNo: 'JK-2026-001' },
  { id: 2, name: '李监考', gender: '女', phone: '13800138002', idCard: '440301198502063456', org: '大亚湾核电', site: '职业技能培训中心', role: '副监考', status: 'active', certNo: 'JK-2026-002' },
  { id: 3, name: '王监考', gender: '男', phone: '13800138003', idCard: '440301199003127890', org: '阳江核电', site: '实操训练基地', role: '流动监考', status: 'active', certNo: 'JK-2026-003' },
  { id: 4, name: '赵监考', gender: '女', phone: '13800138004', idCard: '440301198805064567', org: '台山核电', site: '职业技能培训中心', role: '主监考', status: 'inactive', certNo: 'JK-2026-004' },
]
...
export default function SupervisorManage() {
  ...
  const filtered = supervisors.filter(s =>
    !search || s.name.includes(search) || s.phone.includes(search) || s.certNo.includes(search)
  )
            ...
            {filtered.map(s => (
              <tr key={s.id} className="hover:bg-gray-50">
                ...
                <td className="px-4 py-3">
                  <Badge variant="outline" className={`text-[10px] ${s.status === 'active' ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-700'}`}>
